...
f = h5.File('filename_from_source','r') #filename_from_source at  https://data.mendeley.com/datasets/4r4v785rgx/1 . Download file with name "jet-images_Mass60-100_pT250-300_R1.25_Pix25.hdf5" with size 2gb.
# print(list(f.keys()))
